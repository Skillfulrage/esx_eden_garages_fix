...
Config.Garages = {
	...
	Garage_4 = {	
		...
		DeletePoint = {
			Pos = {x = 365.26,y = 286.96,z = 103.38},
			Color = {r=255,g=0,b=0},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Marker = 1,
	...
	Garage_6 = {	
		...
		DeletePoint = {
			Pos = {x = 824.94,y = -1332.45,z = 26.11},
			Color = {r=255,g=0,b=0},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Marker = 1,
